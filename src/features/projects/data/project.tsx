...
export const projects: Project[] = [
  {
    id: 1,
    title:
      "Development of Web-based Intelligent Parking Management System with Online Booking for City of Malabon University: Pabook",
    description:
      " A web application integrating Internet of Things (IoT) technology to automate and streamline the parking process.",
    imgSrc: pmsImage,
    images: [sampleImg],
    content:
...

  {
    ...
    description:
      "A ticket tracking Report vizualize, anaylze and tracks ticket within a day or weekly.",
  ...
  },
  {
    ...
    description:
      "A ticket dashboard to vizuals trends, filter data within a day, weekly, monthly, or yearly",
    imgSrc: TAEImg,
  ...
  },
  {
    ...
    description:
      "A system to efficiently track and manage beverage stock levels, ensuring timely restocking and minimizing wastage.",
    imgSrc: beberage,
    images: [
      beberage,
      beberage_one,
